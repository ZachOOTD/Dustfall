# Decisions — archive (D1–D235)

Older decisions split out to keep the active `decisions.md` lean — D1–D87 on 2026-05-31, D88–D188 on 2026-06-17, D189–D206 on 2026-06-20, D207–D220 on 2026-06-22, D221–D235 on 2026-07-09. Preserved verbatim; D-numbers are never reused, so cross-references (e.g. "D14") resolve here and stay grep-able. See `decisions.md` for recent entries and the friction-score legend.
