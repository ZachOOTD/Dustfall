# Decisions — archive (D1–D87)

Older decisions split out 2026-05-31 to keep the active `decisions.md` lean. Preserved verbatim; D-numbers are never reused, so cross-references (e.g. "D14") resolve here and stay grep-able. See `decisions.md` for recent entries and the friction-score legend.
