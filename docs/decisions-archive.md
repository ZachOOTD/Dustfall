# Decisions — archive (D1–D206)

Older decisions split out to keep the active `decisions.md` lean — D1–D87 on 2026-05-31, D88–D188 on 2026-06-17, D189–D206 on 2026-06-20. Preserved verbatim; D-numbers are never reused, so cross-references (e.g. "D14") resolve here and stay grep-able. See `decisions.md` for recent entries and the friction-score legend.
