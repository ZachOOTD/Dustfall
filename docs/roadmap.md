...
Infinite chunk streaming (Minecraft-style) remains the queued big-ticket lift. POI overhaul partial — narrative beats and biome-specific POI kinds still backlogged. Other big-ticket items: trading/NPC economy (needs design pass), salvage mechanics overhaul (AAP's noise detection makes "loud salvage attracts worm" concrete now), POI overhaul follow-on (narrative beats: lone-survivor journals + hostile raider holdouts at flagships).
