...
Infinite chunk streaming (Minecraft-style) remains the queued big-ticket lift. Other big-ticket items: trading/NPC economy (needs design pass), POI narrative beats (lone-survivor journals + hostile raider holdouts), biome-specific POI kinds, salvage condition tiers (corroded/pristine), salvage variant interiors per wreck kind.
