...
- 🔨 IN FLIGHT (wave 3): Z8 (podScene port 5191: chute lines INTO the brim, flutter->2-3s, gravity drape wrapping the hull flank, 4+ angle verify) · Z2 (shipScene port 5192: crew-quarters full sci-fi overhaul — bunk alcove/storage/desk/panels/lighting, nothing overlapping at the back wall; + quarters doorway clipping 3rd report <0.1%; hero 5-8 rounds; orchestrator runs the adversarial gate after).
